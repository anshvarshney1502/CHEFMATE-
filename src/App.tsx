...
const BASE_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  html, body { height: 100%; background: #0D0B05; font-family: 'Plus Jakarta Sans', sans-serif; color: #FFF4DC; }
...
function LoadingScreen({ ls }: { ls: LoadState }) {
  ...
  return (
    <div style={{
      ...
      background: 'radial-gradient(ellipse at 50% -5%, rgba(212,168,67,0.12) 0%, transparent 55%), #0D0B05',
      overflow: 'hidden',
      position: 'relative',
    }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{
            ...
            filter: 'drop-shadow(0 16px 40px rgba(212,168,67,0.35))',
          }}>
            👨‍🍳
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'center' }}>
          <h1 style={{
            ...
            fontSize: 42,
            fontWeight: 600,
            background: 'linear-gradient(135deg, #FFF4DC 30%, #C9A86A 80%, #D4A843 100%)',
          ...
          <p style={{
            fontSize: 10, color: '#6B5A35', fontWeight: 600,
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: isComplete
                ? 'linear-gradient(90deg, #D4A843, #D4A843)'
                : 'linear-gradient(90deg, #A07830, #D4A843, #C9A86A)',
              borderRadius: 999,
              boxShadow: isComplete
                ? '0 0 12px rgba(212,168,67,0.5)'
                : '0 0 14px rgba(212,168,67,0.45)',
              transition: 'width 0.4s ease, background 0.4s',
            }} />
          </div>

          {/* Label */}
          <p style={{ fontSize: 12, color: '#C9A86A', fontWeight: 500 }}>
            {phaseLabel}
          </p>

          {ls.modelName && (
            <p style={{
              fontSize: 10, color: '#6B5A35',
              fontFamily: "'JetBrains Mono', monospace",
...
function ErrorScreen({ error, onRetry }: { error: string; onRetry: () => void }) {
  return (
    <div style={{
      ...
      background: '#0D0B05', fontFamily: "'Plus Jakarta Sans', sans-serif",
    }}>
      <style>{BASE_CSS}</style>
      <div style={{
        display: 'flex', flexDirection: 'column', alignItems: 'center',
        ...
        <h2 style={{
          fontFamily: "'Cormorant Garamond', serif",
          fontSize: 26, fontWeight: 600, color: '#FFF4DC',
        }}>
          Initialisation Failed
        </h2>
        <p style={{ fontSize: 13, color: '#C9A86A', lineHeight: 1.7, opacity: 0.8 }}>
          {error}
        </p>
        <button
          onClick={onRetry}
          style={{
            ...
            color: '#0D0B05', fontFamily: "'Plus Jakarta Sans', sans-serif",
        ...
        <p style={{ fontSize: 11, color: '#6B5A35', lineHeight: 1.8 }}>
