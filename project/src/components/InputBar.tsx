    ...
    <div className="input-bar-wrap">
      <div className="input-bar">
        <textarea
          ...
          onKeyDown={handleKey}
          placeholder="Ask anything… ya Hinglish mein bolo"
          rows={1}
          disabled={isSending}
        />
      ...
      <p className="input-hint" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span>Enter to send · Shift+Enter new line · Mic for voice</span>
        {isSpeaking && (
